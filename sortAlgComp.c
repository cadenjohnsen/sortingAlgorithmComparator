...
int main(){
   ...
   printf("Bubble Sort Time:    %d MicroSeconds\n", stop.tv_usec-start.tv_usec);
   nums = temp;
   ...
   gettimeofday(&stop, NULL);
   printf("Insertion Sort Tim:  %d MicroSeconds\n", stop.tv_usec-start.tv_usec);
   nums = temp;
   ...
   gettimeofday(&stop, NULL);
   printf("Merge Sort Time:     %d MicroSeconds\n", stop.tv_usec-start.tv_usec);
   nums = temp;
   ...
   gettimeofday(&stop, NULL);
   printf("Selection Sort Time: %d MicroSeconds\n", stop.tv_usec-start.tv_usec);
